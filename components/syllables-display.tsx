...
export function SyllablesDisplay({
  ...
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="flex flex-wrap gap-x-3 gap-y-2 items-center justify-end">
          ...
          >
            {wordEntry.syllables.map((syllable, syllableIndex) => (
              <span
                ...
                className="inline-block px-2 py-1 border-2 border-blue-500 rounded-lg bg-blue-50 dark:bg-blue-950 text-blue-900 dark:text-blue-100 font-medium"
              >
                {syllable}
              </span>
            ))}
