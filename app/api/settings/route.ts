...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updatedSettings: AppSettings = {
      ...
      morphologyApiKey: baseSettings?.morphologyApiKey || "",
      morphologyUseNiqqudKey: baseSettings?.morphologyUseNiqqudKey ?? true,
      morphologyModel: baseSettings?.morphologyModel || "",
      morphologyPrompt: baseSettings?.morphologyPrompt || "",
      morphologyTemperature: baseSettings?.morphologyTemperature || 0.2,
