...
export const DEFAULT_SYLLABLES_PROMPT = `אתה מומחה בעברית. המשימה שלך היא לחלק טקסט עברי להברות.

חלק את הטקסט הבא להברות והחזר את התוצאה בפורמט הבא: כל מילה בשורה נפרדת, והברות מופרדות במקף (-).
...
החזר רק את הטקסט המחולק להברות ללא הסברים נוספים.
