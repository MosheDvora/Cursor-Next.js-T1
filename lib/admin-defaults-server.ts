...
const SETTINGS_KEY_MAP: Record<keyof AppSettings, string> = {
  ...
  // Morphology settings
  morphologyApiKey: 'morphology_api_key',
  morphologyUseNiqqudKey: 'morphology_use_niqqud_key',
  morphologyModel: 'morphology_model',
  morphologyPrompt: 'morphology_prompt',
  morphologyTemperature: 'morphology_temperature',
  // Appearance settings
